...
QTRSensorsRC qtr((char[]) {19, 18, 17, 16, 15, 14}, 6);
unsigned int sensor[6];
int Threshold[6] = {150, 50, 150, 150, 150, 150};
const int offsetA = 1;

const int offsetB = 1;NewPing sonar(5,5,4);
...
int cm = sonar.ping_cm();
 ...
 /*
     ...
     Serial.print(sensor[4]); Serial.print(" "); Serial.print(sensor[5]); Serial.println(" "); */  
     
      if (sensor[0] > Threshold[0] && cm == 0)
